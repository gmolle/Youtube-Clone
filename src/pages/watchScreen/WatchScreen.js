...
const WatchScreen = () => {
  ...
  return (
    <Row className='p-3'>
      ...
      <Col lg={4} >
        {
         !relatedVideosLoading ? videos?.filter(video=>video.snippet).map((video)=>(<VideoHorizontal video={video} key={video.id.videoId}/>)) : <SkeletonTheme color='#343a40' highlightColor='#3c4147'>
